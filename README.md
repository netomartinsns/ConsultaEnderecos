...
## Observações:
- Foi utilizada a biblioteca GSon para converter o JSON devolvido pela API ViaCEP em um objeto `Endereco`;
- Foi utilizada a biblioteca GSon para salvar um objeto `Endereco` em um arquivo .json;
- O arquivo tem nome o cep informado (exemplo: `04101300.json`);
